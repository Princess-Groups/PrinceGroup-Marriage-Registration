...
import { listRegistrations } from "@/lib/supabase-server";
  ...
  head: () => ({
    meta: [
      { title: "Admin Dashboard — Prince Group Portal" },
      {
        name: "description",
        content:
          "Prince Group admin dashboard for managing marriage registration applications.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--gold)]/40 bg-[color:var(--cream)] px-3 py-1.5 text-xs font-medium text-[color:var(--olive-deep)]">
            <ShieldCheck className="h-3.5 w-3.5 text-[color:var(--gold)]" />
            Preview build · secure login coming in next phase
          </div>
        </div>
